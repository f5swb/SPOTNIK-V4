...
# YSF-FRANCE
  ...
  dvswitchQSY $cmd "YSFN" "YSF" "m55.evxonline.net:42000" ""
  set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yfr"
  close $fp  
	return 1
  }
  ...
  playMsg "Core" "ysffrance"	
  exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "YSFN" "YSF" "ysf-fon.f1tzo.com:42001" ""
	set fp [open "/etc/spotnik/network" "w"];
   puts $fp "yid"
  close $fp  
 	return 1
...
# YSF-Est
  if {$cmd == "3002"} {
	playMsg "Core" "activating"
  playMsg "Core" "Sc4fm"
  playMsg "Core" "ysf_alsace" 
	exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "YSFN" "YSF" "xlx208.f5kav.fr:42000" "" 
	set fp [open "/etc/spotnik/network" "w"];
   puts $fp "yxl"
  close $fp  
	return 1
...
# YSF-ZIT
  ...
  exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "YSFN" "YSF" "151.80.143.185:42002" "" 
  set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yzi"
  close $fp  
  return 1
...
# YSF-Centre France
  ...
  exec nohup /etc/spotnik/restart.num & 
	dvswitchQSY $cmd "YSFW" "YSF" "ysf-fon.f1tzo.com:42002" ""
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "ycf"
  close $fp  
	return 1
...
# YSF-Alpes
  ...
  playMsg "Core" "ysfalpes"   
	exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "YSFN" "YSF" "217.182.66.229:42000" "" 
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yal"
  close $fp  
  return 1
...
# YSF-WALONNIE
  ...
  exec nohup /etc/spotnik/restart.num & 
  dvswitchQSY $cmd "YSFN" "YSF" "vs49.evxonline.net:42000" ""
	set fp [open "/etc/spotnik/network" "w"];
   puts $fp "ywa"
  close $fp   
 	return 1
...
# YSF-Haut-de-France
  ...
  playMsg "Core" "ysfhdf"  
  exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "YSFN" "YSF" "51.15.172.24:42001" ""  
	set fp [open "/etc/spotnik/network" "w"];
   puts $fp "yhf"
  close $fp  
 	return 1
...
# YSF-Linux
  ...
  exec nohup /etc/spotnik/restart.num & 
  dvswitchQSY $cmd "YSFN" "YSF" "213.32.19.95:42000" ""
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yli"
  close $fp   
	return 1
...
# YSF-Test
  ...
  exec nohup /etc/spotnik/restart.num & 
  dvswitchQSY $cmd "YSFN" "YSF" "vps731279.ovh.net:42000" ""
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yte"
  close $fp   
 	return 1
...
# YSF-FraWide
  ...
  exec nohup /etc/spotnik/restart.num & 
  dvswitchQSY $cmd "YSFW" "YSF" "ns3294400.ovh.net:42010" ""	
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "ywi"
  close $fp   
	return 1
...
# YSF-Emcom
  ...
  #playMsg "Core" "ysffrawide"
  exec nohup /etc/spotnik/restart.num & 
	dvswitchQSY $cmd "YSFN" "YSF" "78.206.208.208:42021" ""    
	set fp [open "/etc/spotnik/network" "w"];
   puts $fp "yen"
  close $fp   
  return 1
...
# YSF-NordOuest
  ...
  #playMsg "Core" "ysffrawide"
	exec nohup /etc/spotnik/restart.num & 
	dvswitchQSY $cmd "YSFN" "YSF" "78.206.208.208:42000" ""
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yno"
  close $fp   
	return 1
...
# YSF-NANTES
  ...
  exec nohup /etc/spotnik/restart.num & 
  dvswitchQSY $cmd "YSFN" "YSF" "f5ore.dyndns.org:42000" "" 
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yna"
  close $fp   
	return 1
...
# YSF-WireX
  ...
  exec nohup /etc/spotnik/restart.c4fm & 
	dvswitchQSY $cmd "YSFN" "YSF" "151.80.143.185:42001" ""
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yex"
  close $fp   
	return 1
...
# YSF-FON
  ...
  playMsg "Core" "Sfon" 	
  exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "YSFW" "YSF" "ysf-fon.f1tzo.com:42000" "" 
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yfo"
  close $fp   
  return 1
...
# YSF-INTERNATIONAL-RRF
  ...
  exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "YSFW" "YSF" "ysf-fon.f1tzo.com:42005" ""  
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "yrr"
  close $fp  
  return 1
...
# 40721 Canada Fr
 if {$cmd == "40721"} {
	playMsg "Core" "activating"
  playMsg "Core" "Sp25"
  playMsg "Core" "p25canada"
  exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "P25" "P25" "40721" "" 
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "pca"
  close $fp  
	return 1
...
if {$cmd == "10208"} {
	playMsg "Core" "activating"
  playMsg "Core" "Sp25"
  playMsg "Core" "p25france"   
  exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "P25" "P25" "m55.evxonline.net:41000" "" 
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "pfr"
  close $fp   
	return 1
...
# 65208 France
 if {$cmd == "65208"} {
	playMsg "Core" "activating"
  playMsg "Core" "Snxdn"
  playMsg "Core" "nxdnfrance"
  exec nohup /etc/spotnik/restart.num &
  dvswitchQSY $cmd "NXDN" "NXDN" "m55.evxonline.net:41400" ""
	set fp [open "/etc/spotnik/network" "w"];
    puts $fp "nfr"
  close $fp   
  return 1
...
# DMR-20879
# if {$cmd == "20879"} {
#	dvswitchQSY $cmd "DMR" "DMR" "20879" ""
# exec nohup /etc/spotnik/restart.dmr &   
#  set fp [open "/etc/spotnik/network" "w"];
#    puts $fp "d20879"
#  close $fp    
#	return 1
